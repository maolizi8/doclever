...
$.startLoading=function (scope) {
    ...
    else if(scope==2)
    {
        ...
        ele.style.height="calc(100vh - 158px)";
    }
    else if(scope==3)
    {
	...
	console.log("loading-left:"+ele.style.left)
	console.log("loading-top:"+ele.style.top)
	console.log("loading-width:"+ele.style.width)
	console.log("loading-height:"+ele.style.height)
	
    ele.innerHTML='<div style="text-align: center;margin-top: '+(document.documentElement.clientHeight/2-100)+'px">'
                    +'<div class="fa fa-spinner fa-spin" style="color: #50bfff;font-size: 30px;"></div>'
                    +'<div style="margin-top: 30px;color: gray;font-size: 15px">'
                    +(ele1?arr[parseInt(Math.random()*arr.length)]:"DOClever,做最好的接口管理平台")+'</div></div>'
