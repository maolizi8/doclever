module.exports=new Vuex.Store({
    ...
    mutations:{
        ...
        setUserGroupInfo:function (state,data) {
            state.userGroup.total=data.total;
        },//gql add
    ...
    actions:{
        ...
        addUserGroup:function (context,query) {
            return net.post("post","/admin/user",query).then(function (data) {
                if(data.code==200)
                {
                    context.state.user.list.forEach(function (obj) {
                        if(obj._id==data.data._id)
        ...
        userGroupList:function (context,query) {
            return net.get("/admin/usergroup",query).then(function (data) {
                if(data.code==200)
                {
                    context.state.userGroup.list=data.data;
                    context.state.userGroup.total=data.data.length;
                }
                return data;
            })
        },//gql add
