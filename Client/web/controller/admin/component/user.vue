            ...
            <el-row class="row" style="height: 50px;line-height: 50px;border-bottom:1px lightgray solid">
                <el-col class="col" :span="4">
                    <el-select size="small" v-model="type" style="width: 90%">
                        ...
                        <el-option label="今日注册" :value="3"></el-option>
                        <el-option label="今日登录" :value="1"></el-option>
                        <el-option label="登录最多" :value="2"></el-option>
                        <el-option label="活跃用户" :value="4"></el-option>
                    </el-select>
                </el-col>
                <el-col class="col" :span="16">
                    <el-input size="small" style="width: 80%" placeholder="请输入你要查找的用户" v-model="user" v-if="type==0"></el-input>
                    <span v-else>
                        &nbsp;
                    </span>
                </el-col>
                    ...
                    <template v-for="(item,index) in list">
                        <tr style="text-align: center;vertical-align: middle" :key="item._id">
                            ...
                            <td style="width: 20%">
                                ...
                                <el-button type="text" size="mini"  @click.native="userProject(item,index)">
                                    项目
                                </el-button>
                                <el-button type="text" size="mini"  @click.native="userTeam(item,index)">
                                    团队
                                </el-button>
