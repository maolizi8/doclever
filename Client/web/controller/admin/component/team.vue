                ...
                <template v-for="(item,index) in list">
                    <tr style="text-align: center;vertical-align: middle" :key="item._id">
                        ...
                        <td style="width: 40%">
                            ...
                            <el-button type="text" size="mini"  @click.native="own(item,index)">
                                指定所有者
                            </el-button>
                            <el-button type="text" size="mini"  @click.native="user(item,index)">
                                管理成员
                            </el-button>
                            <el-button type="text" size="mini"  @click.native="project(item,index)">
                                管理项目
                            </el-button>
