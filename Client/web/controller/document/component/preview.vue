...
<script>
    var bodyJSONPreview=require("../../interface/info/interface/component/bodyJSONPreview.vue");
    var outJSONPreview=require("../../interface/info/interface/component/outJSONPreview.vue");
