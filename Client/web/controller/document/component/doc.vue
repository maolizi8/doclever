    ...
    <el-col class="col right_side" style="">
        ...
        <el-row style="" class="right_content">
            <el-col class="col" style="" id="showContent">
                    <el-row class="row" style="margin-top: 10px;font-size: 14px" id="doc">
...
<script>
    ...
    //var store=require("../store")._modulesNamespaceMap["doc/"].context;
    ...
    module.exports = {
        ...
        computed:{
            ...
            publicUrl:function () {
                ...
                return url.substring(0,index+1)+"read/read.html#"+session.get("projectId");
            },
        },
        methods: {
            saveInfo:function () {
            ...
            edit:function () {
                var _this=this;
                $.startHud();
                _this.store.dispatch("list").then(function (data) {
                    $.stopHud();
                    if(data.code==200)
                    {
                        $.showBox(_this,require("./edit.vue"));
                    }
                    else
                    {
                        $.notify(data.msg,0);
            ...
            read:function () {
                window.open($.basePath()+"read/read.html#"+session.get("projectId"),"_blank");
            },
            exportPdf:function () {
                window.open(location.protocol+"//"+location.host+"/doc/exportpdf"+"?project="+session.get("projectId"));
            }
        }
    }
</script>