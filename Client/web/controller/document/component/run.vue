<template>
    <el-row class="row" id="run">
        ...
        <el-row class="row" style="margin-top: 5px;border-radius: 5px;font-size: 14px;background-color: white">
            ...
            <el-row class="row" style="padding-left: 10px;margin-top: 20px">
                <el-input size="small" style="width: 100%" placeholder="请填入根路径" v-model="interface.baseurl"></el-input>
            </el-row>
...
<script>
    var runParam=require("../../interface/info/interface/run/component/runParam.vue");
    ...
    module.exports={
        ...
        created:function () {
            ...
            store.commit("setBaseUrls",this.$props.baseUrls);
            store.commit("setStatus",this.status);
            store.commit("setBefore",this.before);
            store.commit("setAfter",this.after);
        },
    }
</script>