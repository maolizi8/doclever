...
module.exports=new Vuex.Store({
    ...
    mutations:{
        ...
        changeBaseUrl:function(state,val){
            state.baseurl=val;
        },  //geqiuli add
    },
    actions:{
        run:function (context) {
            ...
            else if(!baseurl)   /*else if(!baseUrl)*/
            {
                return new Promise(function (resolve,reject) {
                    var obj={};
                    obj.code=0;
            ...
            var bMock=false;
            if(baseurl!="MockServer")   /**if(baseUrl!="MockServer") */
            {
        ...
        //geqiuli modify: add param:data
        initBaseUrl:function (context,data) {
            //context.commit("setBaseUrl",context.state.baseUrls.length>0?context.state.baseUrls[0].url:"");
            context.commit("setBaseUrl",data.baseurl);
        },
        //geqiuli modify end
        ...
        initData:function (context,data) {
            ...
            context.dispatch("initBaseUrl",data);
