    ...
    <div style="width: 100%">
        <table class="table-hover" style="width: 80%;border-collapse: collapse;">
            <template v-for="(item,index) in arr">
                <tr style="text-align: center;vertical-align: middle;height: 50px" :key="index">
                    <td style="width: 15%">
                    ...
                    <td style="width: 10%;text-align: center">
                        <el-button   size="mini" @click="editRoleOption(item,index)" type="text" v-if="item.role==1 && manageRole">权限设置</el-button>
                    </td>
                    <td style="width: 10%;text-align: center">
