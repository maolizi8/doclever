...
module.exports={
    ...
    getters:{
		interid:function (state,getters,rootState) {
			console.log("interface>info>interface>store.js")
			console.log(rootState.info.interid)
            return rootState.info.interid;
        },
		interfaceSort:function (state,getters,rootState) {
			console.log("interface>info>interface>store.js")
			console.log(rootState.info.interfaceSort)
            return rootState.info.interfaceSort;
        },
    ...
    mutations:{
                    ...
                    arr.push({
                        ...
                        value:param2[1]?{
                            ...
                            data:[{
                                ...
                                value:decodeURIComponent(param2[1].replace(/\+/g, '%20')),
                                remark:""
                            }]
                        }:{
                            type:0,
        ...
        changeBaseUrl:function(state){
            console.log("info-interface-stroe.js--<changeBaseUrl>")
            console.log(state.interfaceEdit.baseurl)
            console.log(val)
            /* if(val){
                var arrParam=[];
                var arr=val.match(/^((ht|f)tps?):\/\/([\w-]+(\.[\w-]+)*\/?)$/);
            } */
        },  //geqiuli add
    ...
    actions:{
        ...
        getAllInterface:function (context,data) {
            ...
            // console.log("getAllInterface -- <data.baseUrl>");   //geqiuli add
            // console.log(data);
        ...
        refresh:function (context) {
			console.log("refresh--context.getters.interid");   //geqiuli add
            console.log(context.getters.interid);
            ...
            return net.get("/project/interface",{
                ...
                //sort:context.getters.interfaceSort?context.getters.interfaceSort:0
            }).then(function (data) {
                if(data.code==200)
                {
                    context.dispatch("refreshData",data.data.data);

                    console.log("refresh--<data.data.baseUrl>");   //geqiuli add
        ...
        save:function (context) {
            console.log('project>info>interface>store.js--save--')
            var obj={
