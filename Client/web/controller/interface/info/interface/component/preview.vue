    ...
    <el-row class="row" id="mainPreview">
        ...
        <el-row class="row" id="interfaceMainBody" style="">
            ...
            <el-row class="row" style="padding-left: 10px;padding-top: 20px">
                Method:  <span style="color:blue;">{{interfaceEdit.method}}</span>
            </el-row>
			<!--<el-row class="row" style="padding-left: 20px;padding-top: 10px;color: #17b9e6">
                {{interfaceEdit.method}}
            </el-row> -->
			<el-row class="row" style="padding-left: 10px;padding-top: 20px">
                BaseUrl:  <span style="color:blue;">{{interfaceEdit.baseurl}}</span>
            </el-row>
            <el-row class="row" style="padding-left: 10px;padding-top: 20px">
                Path:     <span style="color:blue;">{{interfaceEdit.url}}</span>
            </el-row>
            <!-- <el-row class="row" style="padding-left: 20px;padding-top: 10px;color: #17b9e6">
                    {{interfaceEdit.url}}
            </el-row> -->
            <el-row class="row" style="padding-left: 10px;padding-top: 20px">
                状态:     <span style="color:blue;">{{interfaceEdit.finish==1?"开发完成":(interfaceEdit.finish==2?"已废弃":"开发中")}}</span>
            </el-row>
                            ...
                            <el-row class="row" style="padding:0 30px;">
                                <table style="width: 100%;border-collapse: collapse" class="table-hover">
                                    ...
                                    <template v-for="(item,index) in param">
                                        <tr :key="index" style="text-align: center;vertical-align: middle;height: 40px;word-break: break-all">
                                            <td style="width: 30%">
                                                {{item.name}}
                                            </td>
                                            <td style="width: 70%">
                        ...
                        <expand v-if="querySave.length>0" ref="query">
                            ...
                            <el-row class="row" style="padding:0 30px;">
                                <table style="width: 100%;border-collapse: collapse" class="table-hover">
                                    ...
                                    <tbody>
                                    <template v-for="(item,index) in querySave">
                                        <tr style="text-align: center;vertical-align: middle;height: 40px;word-break: break-all" :key="index">
                                            <td style="width: 30%">
                                                {{item.name}}
                                            </td>
                                            <td style="width: 20%">
                        ...
                        <expand v-if="headerSave.length>0" ref="header">
                            ...
                            <el-row class="row" style="padding:0 30px;">
                                <table style="width: 100%;border-collapse: collapse" class="table-hover">
                                    ...
                                    <tbody>
                                    <template v-for="(item,index) in headerSave">
                                        <tr style="text-align: center;vertical-align: middle;height: 40px;word-break: break-all" :key="index">
                                            <td style="width: 30%">
                                                {{item.name}}
                                            </td>
                        ...
                        <expand v-if="(interfaceEdit.method=='PUT' || interfaceEdit.method=='POST' || interfaceEdit.method=='PATCH') && (bodySave.length>0 || bodyInfo.type==1)" ref="body">
                            ...
                            <el-row class="row" style="padding:0 30px;">
                                <table style="width: 100%;border-collapse: collapse" v-if="bodyInfo.type==0" class="table-hover">
                                    ...
                                    <tbody>
                                    <template v-for="(item,index) in bodySave">
                                        <tr style="text-align: center;vertical-align: middle;height: 40px;word-break: break-all" :key="index">
                                            <td style="width: 30%">
                                                {{item.name}}
                                            </td>
                                ...
                                <el-row v-else-if="bodyInfo.type==1 && bodyInfo.rawType==2">
                                    ...
                                    <el-row class="row" style="margin-top: 10px">
                                        <div v-show="!bodyJSONType">
                                            <template v-for="(item,index) in rawJSON">
                                                <div class="row" style="font-size: 14px;min-height: 25px;line-height: 25px;margin: 0;padding: 0;background-color: #fff9e6;word-break: break-all" v-html="item" :key="index">
                                                </div>
                                            </template>
                                        </div>
...
<style>
    ...
    #interfaceMainBody{
        margin-top: 5px;
        overflow-y: auto;height: calc(100vh - 158px);
        padding: 5px;
