<template>
    <el-dialog title="接口迁移项目和分组"  width="80%" ref="box" :visible.sync="showDialog" append-to-body>
       
        <el-form ref="form" label-width="130px">
            <el-form-item label="选择项目和分组:">
                <el-cascader size="mini" style="width: 90%" expand-trigger="hover" :options="optionArr" v-model="selProjectGroup" @change="changeCollection" placeholder="请选择项目/分组">
                </el-cascader>
            </el-form-item>
        </el-form>
...
<script>
    ...
    module.exports={
        ...
        computed:{
            ...
            //    console.log("interfaceTransfer.vue>optionArr")
            //    console.log(arr)
                return arr
            }
        },
               ...
               var collectionSel=this.selProjectGroup;
                ...
                net.post("/interface/transferproject",query).then(function (data) {
                    ...
                    if(data.code==200)
                    {
                        ...
                        _this.$emit("save",{
                            interface:_this.interfaceId,
                            project:collectionSel[0].toString(),
                            group:collectionSel[1].toString()
                        });
                    }
                    else
                    {
