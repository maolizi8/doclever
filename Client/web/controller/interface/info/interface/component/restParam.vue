    ...
    <el-row class="row">
        <table style="width: 100%">
            <template v-for="(item,index) in arr">
                <tr :key="index" style="text-align: center;vertical-align: middle;height: 50px;line-height: 50px">
                    <td style="width: 30%">
                        {{item.name}}
                    </td>
                    <td style="width: 50%">
                                    ...
                                    <table width="100%" class="table-hover" style="border-collapse: collapse">
                                        <template v-for="(item1,index) in item.value.data">
                                            <tr :key="index" style="text-align: center;vertical-align: middle;">
                                                ...
                                                <td style="width: 60%;border-bottom: 1px solid #e6ebf5;    word-break: break-word;">
