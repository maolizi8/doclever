<template>
    <el-row class="row">
        <el-row class="row" style="height: 35px;line-height: 35px">
            ...
            <el-dropdown split-button type="primary" size="mini" style="float: right;margin-right: 5px;margin-left: 0px" @click="$store.dispatch('changeType','run')" v-else>
                ...
                <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item v-for="(item,index) in arrExample" :key="index" @click.native="run(item)">
                        {{item.name}}
                    </el-dropdown-item>
                </el-dropdown-menu>
            </el-dropdown>
        ...
        <el-row class="row" style="margin-top: 5px;overflow-y: auto;height: calc(100vh - 158px);padding-bottom: 80px;padding: 5px;border-top: 1px solid #ccc;">
            <el-row class="row" style="background-color: white;border-radius: 5px;box-shadow: 0 2px 4px 0 rgba(0,0,0,.12), 0 0 6px 0 rgba(0,0,0,.24)">
                ...
                <el-form label-position="top" label-width="80px" style="padding: 10px 20px 20px 10px" id="interfaceBasicInfo">
                     ...
                     <el-row class="row line-36">
                        ...
                        <el-col class="col" :span="10">
                            <el-select style="width: 90%;text-align: center" v-model="interfaceEdit.method" @input="changeMethod" size="small">
                    ...
                    <el-row class="row line-36">
                        <el-col class="col" :span="2">
                            <span style="color:red;">*</span>根路径
                        </el-col>
                        <el-col class="col" :span="10">
                            <el-input style="width: 90%" size="small" v-model.trim="interfaceEdit.baseurl" placeholder="请输入根路径BaseUrl"></el-input>
                        </el-col>
                        <el-col class="col" :span="2">
                            <span style="color:red;">*</span>路径
                        </el-col>
                        <el-col class="col" :span="10">
                            <el-input size="small" style="width: 90%" placeholder="请输入接口路径(不包含BaseUrl)" v-model.trim="interfaceEdit.url" @input="changeUrl" @paste.native="paste">
                                </el-input>
                        </el-col>
                    </el-row>
                    <el-row class="row line-36">
                        ...
                        <el-col class="col" :span="22">
                            ...
                            <el-tooltip class="item" effect="dark" :content="interfaceEdit.remark" placement="bottom" :disabled="!interfaceEdit.remark">
                                <el-input style="width: 95%" :rows="3" size="small" v-model="interfaceEdit.remark">
                   ...
                   <!-- <el-row class="row">
                        ...
                        <el-col class="col" :span="12">
                            <el-form-item label="简介">
                                <el-tooltip class="item" effect="dark" :content="interfaceEdit.remark" placement="bottom" :disabled="!interfaceEdit.remark">
                                    <el-input style="width: 90%" :rows="3"  size="small" v-model="interfaceEdit.remark">
                                        <i slot="suffix" class="el-input__icon el-icon-edit" @click="editRemark" style="cursor: pointer"></i>
                                    </el-input>
                                </el-tooltip>
                            </el-form-item>
    ...
    module.exports = {
        ...
        computed:{
            ...
            shareUrl:function () {
                if(this.interfaceEdit)
                {   
                    //geqiuli modify baseUrl->projectBaseUrl
                    return con.projectBaseUrl+"/html/web/controller/share/share.html#"+this.interfaceEdit._id;
                }
                else
                {
                    return ""
        ...
        methods: {
            ...
            save:function () {
                ...
                else if(!this.interfaceEdit.baseurl)
                {
                    $.tip("请填入接口baseurl",0);  //geqiuli add baseurl check
                    return;
                }
            ...
            changeBaseUrl:function(val){
                this.$store.commit("changeBaseUrl");
            },
            ...
            run:function (item) {
				console.log("interface>info>interface>component>edit.vue>run>item")
				console.log(item)
				console.log("interface>info>interface>component>edit.vue>run>this.$store.interface")
				console.log(this.$store.state.interface)
				
				/*console.log(this.$store.state.interface.param[this.$store.state.index])
				this.$store.state.interface.param[this.$store.state.index].selExample={
                            id:item._id,
                            value:item.name
                        } 
				console.log(this.$store.state.interface.param[this.$store.state.index])*/
