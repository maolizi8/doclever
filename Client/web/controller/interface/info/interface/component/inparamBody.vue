<template>
    <el-row class="row">
        <el-row class="row" style="padding:0 0 0 20px;height: 36px;line-height: 36px;white-space: nowrap">
        ...
        <table width="100%" v-if="info.type==0">
            ...
            <template v-for="(item,index) in arr">
                <tr class="tr-line" :key="index">
                    <td style="width: 20%;text-align: center;vertical-align: middle;">
                        <el-input size="small" class="param-input" placeholder="请填写参数名称" v-model.trim="item.name" @input="index==arr.length-1?arr.push({name:'',type:0,must:0,remark:''}):''">
						</el-input>
                    </td>
                    <td style="width: 15%;text-align: center;vertical-align: middle;">
                        <el-select size="small" v-model="item.type" class="param-input" >
                    ...
                    <td style="width: 10%;" >
                        <span style="display: inline-block;">
                            <el-checkbox v-model="item.must" :true-label="1" :false-label="0">
								<!-- 必选 -->
							</el-checkbox>
                        </span>
                    </td>
                    <td style="width: 45%">
                        <el-input size="small" class="param-input" placeholder="请填写备注" v-model="item.remark"></el-input>
                    </td>
                    <td style="width: 5%">
        ...
        <el-row class="row" style="height: 36px;line-height: 36px" v-else>
            <el-col class="col" :span="20" style="text-align: center">
                <el-input size="small" class="param-input" placeholder="请填写备注" v-model="info.rawTextRemark" v-if="info.rawType==0"></el-input>
                <el-input size="small" class="param-input" placeholder="请填写备注" v-model="info.rawFileRemark" v-else></el-input>
            </el-col>
