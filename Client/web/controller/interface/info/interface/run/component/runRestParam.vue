    ...
    <el-row class="row">
        <table style="width: 100%" id="paramTable">
            <template v-for="item in arr">
                <tr style="text-align: center;vertical-align: middle;height: 36px;line-height: 36px" :key="index">
                    <td style="width: 30%">
                        {{item.name}}
                    </td>
                    <td style="width: 40%;line-height: normal;line-height: normal;    word-break: break-word;">
    ...
    module.exports={
        ...
        methods:{
            configValue:function (item) {
                ...
                var child=$.showBox(this.$parent,require("../../component/valueList.vue"),{
                    "source":item.value
                });
