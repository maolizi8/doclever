<template>
    <el-dialog title="快速加入用例-测试" width="80%" ref="box" :visible.sync="showDialog" append-to-body>
        <el-row class="row">
            <el-form label-position="top" label-width="80px" style="padding: 0 100px 10px 10px;" id="testBasicInfo" v-if="testType==1">
                <el-row class="row">
                    <el-col class="col" :span="24">
                        <el-form-item label="选择：测试项目/模块/业务" style="margin-bottom:5px;">
                            <el-cascader size="small" expand-trigger="hover" :options="arrGroup" v-model="$store.state.groupModel" style="width: 95%" :props="defaultProps"></el-cascader>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row class="row">
                    <el-col class="col" :span="12">
                        <el-form-item label="用例名称" style="margin-bottom:5px;">
            ...
            <el-row class="row" v-else>
                <el-form label-width="100px">
                    <el-form-item label="选择用例">
                        <el-cascader size="small" expand-trigger="hover" :options="arrTest" v-model="arrSelTest" style="width: 90%" :props="defaultProps" @change="changeTest" filterable clearable>
            ...
            <el-row class="row" style="background-color: white;padding-bottom: 30px;">
                <el-row class="row" style="height:40px;line-height: 40px;padding-left: 10px;font-size: 14px;color: #17B9E6">
                    ...
                    <el-button type="text" size="mini" style="float: right;margin-top: 15px" :icon="interfacePending?'el-icon-loading':'el-icon-check'">
                        {{interfacePending?"接口数据初始化中":"接口数据初始化完成"}}
                    </el-button>
                </el-row>
 ...
 */
    ...
    var store=require("../../../store")._modulesNamespaceMap["info/interface/test/"].context;
    var testContentCode=require("../../../../testproj/test/component/testContentCode.vue");
    var testContentUI=require("../../../../testproj/test/component/testContentUI.vue");
    module.exports = {
        ...
        created:function () {
            ...
            if(this.propJoin)
            {
                store.state.selTest.ui.push(this.propJoin);
            }
        },
