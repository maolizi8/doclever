module.exports= {
    ...
    actions:{
        showInterface:function (context,data) {
            return context.dispatch("project/test/showInterface",data,{
                root:true
            })
        },
        changeExample:function (context,data) {
            return context.dispatch("project/test/changeExample",data,{
                root:true
            })
        },
        save:function (context) {
            ...
            console.log('interface>interface>test>store.js>context.state.groupModel')
            console.log(context.state.groupModel)
