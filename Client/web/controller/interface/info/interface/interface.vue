<template>
    <el-row class="row" style="padding: 0 10px 0 10px;">
        <el-col class="col" :span="bMax?0:6" style="padding-right: 5px;">
            <el-row class="row" style="height: 35px;line-height: 35px;padding-left:5px;">
                ...
                <el-dropdown trigger="hover">
                    ...
                    <el-dropdown-menu slot="dropdown">
                        ...
                        <el-dropdown-item>
							<div @click="sortType=1">
								<i class="el-icon-check" style="color: #11b95c" v-if="sortType==1"></i>&nbsp;修改时间
								</div>
							</el-dropdown-item>
                        <el-dropdown-item>
							<el-tooltip class="item" effect="dark" content="自定义排序下可以拖动接口或分组来排序" placement="right">
								<div @click="sortType=2">
									<i class="el-icon-check" style="color: #11b95c" v-if="sortType==2"></i>
									&nbsp;自定义</div>
							</el-tooltip>
						</el-dropdown-item>
                    </el-dropdown-menu>
            ...
            <el-row class="row" id="leftInterfaceList" style="">
                ...
                <el-row style="height: calc(100vh - 212px);overflow-y: scroll;">
                    <list></list>
                </el-row>
                
            </el-row>
        </el-col>
        <el-col :span="bMax?24:18" class="col" id="interfaceContent" style="">
 ...
 */
    ...
    var store=require("../../store")._modulesNamespaceMap["info/interface/"].context;
    ...
    module.exports = {
        ...
        methods:{
            ...
            importGroup:function () {
                var _this=this;
                $.inputMul(_this,"请输入DOClever导出分组的JSON",function (val) {
                    if(!val)
                    {
                        $.tip("请输入JSON",0);
                        return false;
