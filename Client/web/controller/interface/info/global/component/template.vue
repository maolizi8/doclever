<template>
    <el-dialog title="编辑模板" style="width:80%;padding:10px 20px;" ref="box" id="templateEdit" :visible.sync="showDialog" append-to-body>
        <el-row class="row" style="margin-top: 5px;overflow-y: auto;background-color: rgb(244,241,244)">
            <el-row class="row" style="background-color: white;border-radius: 5px;box-shadow: 0 2px 4px 0 rgba(0,0,0,.12), 0 0 6px 0 rgba(0,0,0,.04)">
                ...
                <el-form label-position="top" label-width="80px" style="padding: 10px 100px 20px 10px" id="templateBasicInfo">
                    ...
                    <el-row class="row">
                        <el-col class="col" :span="12">
                            <el-form-item label="根路径BaseUrl">
                                <el-input style="width: 90%" size="small" placeholder="请输入接口BaseUrl" v-model.trim="interfaceEdit.baseurl" @input="changeBaseUrl" ></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col class="col" :span="12">
                            <el-form-item label="路径path">
                                <el-input size="small" style="width: 90%" placeholder="请输入接口路径(不包含BaseUrl)" v-model.trim="interfaceEdit.url" @input="changeUrl" @paste.native="paste"></el-input>
                            </el-form-item>
                        </el-col>
        ...
        methods: {
            ...
            save:function () {
                ...
                var obj={
                    ...
                    project:this.$store.getters.interid,
