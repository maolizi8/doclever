    ...
    <el-dialog title="选择接口"  width="50%" ref="box" :visible.sync="showDialog" append-to-body>
        <el-form ref="form" label-width="100px">
            <el-form-item label="接口">
                <el-cascader size="small" expand-trigger="hover" :options="arrInterface" v-model="selInterface" :show-all-levels="true" placeholder="请选择接口" :props="props" filterable clearable style="width: 90%">
                </el-cascader>
            </el-form-item>
