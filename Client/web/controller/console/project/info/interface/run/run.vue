<template>
    <el-row class="row" id="run">
        <el-row class="row" style="height: 35px;line-height: 35px">
            ...
            <el-button type="primary" size="mini" style="margin-left: 5px;" @click="joinTest">
        ...
        <el-row class="row" style="margin-top: 5px;overflow-y: auto;height: calc(100vh - 150px);padding-bottom: 80px;border-radius: 5px;font-size: 14px;background-color: white">
            ...
            <el-row class="row" style="height: 40px;line-height: 40px;padding-left: 10px;padding-right: 10px">
                ...
                <el-col class="col" :span="7">
                    <el-input size="small" style="width: 95%" placeholder="请填入根路径" v-model.trim="interface.baseurl" @input="changeBaseUrl" ></el-input>
                </el-col>
                <el-col class="col" :span="11">
                    <el-input size="small" style="width: 100%" placeholder="请填入你请求的路由地址" v-model.trim="interface.url" @input="changeUrl" @paste.native="paste"></el-input>
                </el-col>
            </el-row>
