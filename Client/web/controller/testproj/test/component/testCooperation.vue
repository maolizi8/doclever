<template>
    <el-dialog title="编辑协助者"  width="50%" ref="box" :visible.sync="showDialog" append-to-body>
        <el-row class="row">
            <el-row class="row" style="height: 50px;line-height: 50px;text-align: center" v-for="item in arr" :key="item.name">
...
<script>
    ...
    module.exports={
        props:["arrUser","arrCooperation","testid"],
        data:function () {
            return {
                showDialog:false,
                testid:this.testid,
        ...
        methods:{
            save:function () {
                ...
                var _this=this;
                console.log("testCooperation.vue>testid")
