<template>
    <el-row class="row">
        ...
        <el-row class="row content-body" style="">
            <el-row class="row" style="background-color: white;border-radius: 5px;box-shadow: 0 2px 4px 0 rgba(0,0,0,.12), 0 0 6px 0 rgba(0,0,0,.24);padding-bottom: 15px" >
                ...
                <el-form label-position="top" label-width="80px" style="padding: 10px 100px 20px 10px" id="testBasicInfo">
                    ...
                    <el-row class="row line-36">
                        <el-col class="col" :span="2">
                            <span style="color:red;">*</span>业务
                        </el-col>
                        <el-col class="col" :span="22">
                             <el-cascader size="small" expand-trigger="hover" :options="arrGroup" v-model="groupModel" style="width: 95%"></el-cascader>
                        </el-col>
                    </el-row>
                    <el-row class="row line-36">
                        <el-col class="col" :span="2">
                            <span style="color:red;">*</span>用例名称
                        </el-col>
                        <el-col class="col" :span="10">
                            <el-input size="small" style="width: 90%" placeholder="请输入用例名称" v-model="test.name"></el-input>
                        </el-col>
                        <el-col class="col" :span="2">
                           &nbsp;状态
                        </el-col>
            ...
            <el-row class="row" style="background-color: white;margin-top: 15px;padding-bottom: 30px;border-radius: 5px;box-shadow: 0 2px 4px 0 rgba(0,0,0,.12), 0 0 6px 0 rgba(0,0,0,.04);">
                ...
                <el-row class="row" style="height: 1px;background-color: lightgray"></el-row>
                <testcode v-show="type=='code'" ref="code" :testid="testid"></testcode>
                <testui v-show="type=='ui'" ref="ui" :testid="testid"></testui>
            </el-row>
