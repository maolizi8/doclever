    ...
    module.exports = {
        ...
        methods: {
            ...
            keyPress:function (event,item) {
                console.log('testUITestArgv.vue>keyPress>item')
                console.log(item)
                console.log('testUITestArgv.vue>keyPress>this.$root,event.target')
                console.log(this.$root,event.target)
                console.log('testUITestArgv.vue>keyPress>$')
