    ...
    <el-dialog title="编辑接口入参"  width="70%" ref="box" :visible.sync="showDialog" append-to-body>
        <el-row class="row">
            <el-tabs v-model="type">
                ...
                <el-tab-pane name="requestObj" label="RequestObj">
                    <el-row class="row param-line" v-for="(item,index) in requestObj" style="" :key="index">
                        <el-col class="col" :span="6">
                            <el-select size="small" v-model="item.key">
                        ...
                        <el-col class="col" :span="13">
                            <el-input size="small" v-model="item.value" style="width: 95%" placeholder="请输入value" @keypress.native="keyPress($event,item)">
                            </el-input>
                        </el-col>
                        <el-col class="col" :span="1" >
                            <el-button size="mini" type="text" style="font-weight: 900;font-size: 16px;" icon="el-icon-plus"
							@click="requestObj.splice(index+1,0,{key:'',value:'',type:'string'})"></el-button>
                        </el-col>
                        <el-col class="col" :span="1">
                            <el-button size="mini" type="text" style="font-weight: 900;color:red;font-size: 16px;" icon="el-icon-close" 
							@click="index>0?requestObj.splice(index,1):(item.key='',item.value='')"></el-button>
                        </el-col>
                    </el-row>
                </el-tab-pane> 

                <!-- <el-tab-pane name="param" label="Param">
                    <el-row class="row param-line" v-for="(item,index) in param" style="" :key="index">
                        <el-col class="col" :span="6">
                            <el-input size="small" v-model="item.key" style="width: 95%" placeholder="请输入key">
                            </el-input>
                        </el-col>
                        <el-col class="col" :span="3">
                            <el-select size="small" v-model="item.type">
                        ...
                        <el-col class="col" :span="1" >
                            <el-button size="mini" type="text" style="font-weight: 900;font-size: 16px;" icon="el-icon-plus"
							@click="param.splice(index+1,0,{key:'',value:'',type:'string'})"></el-button>
                        </el-col>
                        <el-col class="col" :span="1">
                            <el-button size="mini" type="text" style="font-weight: 900;color:red;font-size: 16px;" icon="el-icon-close" 
							@click="index>0?param.splice(index,1):(item.key='',item.value='')"></el-button>
                        </el-col>
                    </el-row>
                </el-tab-pane> -->
				
                <el-tab-pane name="query" label="Query">
                    <el-row class="row param-line" v-for="(item,index) in query" style="" :key="index">
                        <el-col class="col" :span="6">
                            <el-input size="small" v-model="item.key" style="width: 95%" placeholder="请输入key">
                            </el-input>
                        </el-col>
                        ...
                        <el-col class="col" :span="1">
                            <el-button size="mini" type="text" style="font-weight: 900;color:red;font-size: 16px;" icon="el-icon-close" 
							@click="index>0?query.splice(index,1):(item.key='',item.value='')"></el-button>
                        </el-col>
                    </el-row>
                </el-tab-pane>
                <el-tab-pane name="header" label="Header">
                    <el-row class="row param-line" v-for="(item,index) in header" :key="index" style="">
                        <el-col class="col" :span="6">
                            <el-input size="small" v-model="item.key" style="width: 95%" placeholder="请输入key">
                            </el-input>
                        </el-col>
                        ...
                        <el-col class="col" :span="1">
                            <el-button size="mini" type="text" style="font-weight: 900;color:red;font-size: 16px;" icon="el-icon-close" 
							@click="index>0?header.splice(index,1):(item.key='',item.value='')"></el-button>
                        </el-col>
                    </el-row>
                </el-tab-pane>
                <el-tab-pane name="body" label="Body">
                    <el-row class="row param-line" v-for="(item,index) in body" style="" :key="index">
                        <el-col class="col" :span="6">
                            <el-input size="small" v-model="item.key" style="width: 95%" placeholder="请输入key">
                            </el-input>
                        </el-col>
                        ...
                        <el-col class="col" :span="1">
                            <el-button size="mini" type="text" style="font-weight: 900;color:red;font-size: 16px;" icon="el-icon-close" 
							@click="index>0?body.splice(index,1):(item.key='',item.value='')"></el-button>
                        </el-col>
                    </el-row>
                </el-tab-pane>
            </el-tabs>
    ...
    module.exports = {
        ...
        data: function () {
            return {
                ...
                requestObj:function (data) {
					...
					return arr;
				}.call(this,this.argv.requestObj),//gql add
        ...
        methods: {
            save:function () {
                ...
                var temp={};
                this.requestObj.forEach(function (obj) {
                    if(obj.key)
                    {
                        temp[obj.key]=helper.setArgvValue(obj.value,obj.type)
                    }
                })
                this.argv.requestObj=temp;
