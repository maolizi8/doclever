...
var interface=[
    ...
    },
    {
        ...
        "path":"/admin/userlist",
        "param": {
            type:Number,       //0-所有用户/用户搜索,   1-今天登陆,   2-登陆最多, 3-今日注册, 
            page:Number,
            key:{
                type:String,
                optional:1
...

    {
        ...
        "data":String,
        admin:1,
        handle:[admin.userGroupList]
    },//gql add
    {
        "method":"GET",
        "path":"/admin/groupusers",
        "param": {
            id:String
        },
        "data":String,
        admin:1,
        handle:[admin.groupUsers]
    },//gql add

    {
        "method":"POST",
        "path":"/admin/saveusergroup",
        "param": {
            id:{
                type:String,
                optional:1
        ...
        "data":String,
        admin:1,
        handle:[admin.saveUserGroupList]
    },//gql add
];
