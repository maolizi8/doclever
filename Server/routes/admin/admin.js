...
function Admin()
{
    ...
    this.userGroupList=async (req,res)=>{
        try
        {
            let arr=await (this.admin.userGroupList(req.clientParam.name));
            util.ok(res,arr,"ok")
        }
        catch (err)
        {
    ...
    this.saveUserGroupList=async (req,res)=>{
        try
        {   
            let obj=await (this.admin.saveUserGroupList(req.clientParam.id,req.clientParam.name,req.clientParam.dis,req.clientParam.users));
            if(obj)
            {
                util.ok(res,obj,"ok");
            }
